...
def pr2_mover(object_list):
    # The following code to generate output yaml files was obtained from discussion in slack udacity_perception channel from "reno" and "tokyo_adam"
    ...
    for i in range(0, len(object_list_param)):
        ...
        if object_group =='green':
        	...
        	arm_name.data = 'left'
        # TODO: Create a list of dictionaries (made with make_yaml_dict()) for later output to yaml format3
        for i in range(0, len(object_list_param)):
...
if __name__ == '__main__':
    ...
    model = pickle.load(open('/home/robond/catkin_ws/model_1.sav', 'rb'))
